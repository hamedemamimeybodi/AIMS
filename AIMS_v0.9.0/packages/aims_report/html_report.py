...
<body>
  ...
  <div class="scores">
    ...
    {_score_card('OpenBIM', sc.openbim_readiness)}
  </div>
  ...
  <table>
    ...
    <tr><td>OpenBIM</td><td>{summary.openbim['score']}</td><td>{summary.openbim['openbim_entities']} export-ready entities, {summary.openbim['missing_pset_properties']} missing PSet values</td></tr>
  </table>
