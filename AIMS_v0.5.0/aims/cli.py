...
def audit_command(args: argparse.Namespace) -> int:
    ...
    merged_standard = {**standard, **bim_standard, **gis_standard, **rules_standard}
    ...
    write_markdown_report(document, report_path, bim_readiness=bim, gis_readiness=gis, rule_result=rules)
