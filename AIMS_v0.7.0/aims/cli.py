...
def audit_command(args: argparse.Namespace) -> int:
    ...
    merged_standard = {**standard, **bim_standard, **gis_standard, **rules_standard, **plugin_standard}
    ...
    write_markdown_report(document, report_path, bim_readiness=bim, gis_readiness=gis, rule_result=rules, plugin_summary=plugins)
    write_html_report(document, html_path, bim_readiness=bim, gis_readiness=gis, rule_result=rules, plugin_summary=plugins)
    write_json_report(document, json_report_path, bim_readiness=bim, gis_readiness=gis, rule_result=rules, plugin_summary=plugins)
