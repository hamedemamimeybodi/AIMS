...
def build_report_summary(
    ...
    scorecard = ReportScorecard(
        ...
        openbim_readiness=_safe_score(openbim.score),
        overall=compute_overall_score([arch_score, bim.score, gis.score, rules.score, plugins.score, openbim.score]),
    )
    ...
    return ReportSummary(
        ...
        openbim={
            "score": openbim.score,
            "total_entities": openbim.total_entities,
            "openbim_entities": openbim.openbim_entities,
            "missing_ifc_guid": openbim.missing_ifc_guid,
            "missing_spatial_container": openbim.missing_spatial_container,
            "missing_pset_properties": openbim.missing_pset_properties,
            "unsupported_ifc_classes": openbim.unsupported_ifc_classes,
            "ifc_class_counts": openbim.ifc_class_counts,
        },
        plugins={
            "score": plugins.score,
