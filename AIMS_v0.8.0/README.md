...
The `.ifc` output in v0.8.0 is an early OpenBIM foundation export. It is intentionally simple and deterministic. Full geometry-rich IFC authoring should be implemented later with an IFC library such as IfcOpenShell. Pretending otherwise would be software theater, and we already have enough of that.
