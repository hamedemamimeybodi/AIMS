...
def build_release_manifest(root: str | Path = ".", version: str = "1.0.0") -> ReleaseManifest:
    base = Path(root)
...
def write_release_manifest(root: str | Path = ".", out: str | Path = "reports/release_manifest.json", version: str = "1.0.0") -> ReleaseManifest:
    base = Path(root)
